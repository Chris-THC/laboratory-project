...
const FormSchema = z.object({
    ...
    dateOfBirth: z.date({
        required_error: 'El año de nacimiento es requerido'
      }),
    doctor: z.string({
    ...
    status: z.string().min(2, {
        message: 'El tipo de estado es requerido'
      })
  })
    ...
    const form = useForm<z.infer<typeof FormSchema>>({
      ...
      defaultValues: !clientObjectInfo
        ...
        : {
            ...
            status: clientObjectInfo.status.toString() === 'Admin'  ? '0' : '1'
          }
    })
            ...
            <FormField
                ...
                render={({ field, fieldState }) => (
                  <FormItem>
                    ...
                    <FormControl>
                    <Input
                        type="date" placeholder="Ingrese la fecha de nacimiento" {...field}
